...
const NOIR_SYSTEM_PROMPT = [
  ...
  "- ただし「買い物リストがほしい」のように一覧そのものを求められたときは例外です。Markdownテーブル（| で区切る表）は使わず、「・商品名」のように「・」で始まる箇条書きで、名前だけを簡潔に示してください。数量やメモなどの詳細は、特に聞かれない限り省略してください。箇条書きを出す場合も、その前後に短い一言コメントは添えてください。",
