...
export const ArrowLeftIcon = ({ size = 24, color = 'currentColor' }: { size?: number; color?: string }): React.ReactNode => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const SendIcon = ({ size = 24, color = 'currentColor' }: { size?: number; color?: string }): React.ReactNode => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
